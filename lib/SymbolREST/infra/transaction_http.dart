...
import 'https.dart';
import 'statistics_service_http.dart';
...
class TransactionHttp {
  ...
  /// トランザクションクラス生成
  Transaction _createTransactionEntity(Map<String, dynamic> jsonData,
  ...
  /// 転送トランザクションクラス生成
  TransferTransaction _createTransferTransactionEntity(
  ...
  /// アグリゲートトランザクションクラス生成
  AggregateTransaction _createAggregateTransactionEntity(
      Map<String, dynamic> jsonData) {
    /** トランザクション情報 **/
    ...
    for (Map<String, dynamic> cosignature in jsonData['transaction']
        ['cosignatures']) {
    ...
    for (Map<String, dynamic> innerTx in jsonData['transaction']
        ['transactions']) {
      innerTransactionList
          .add(_createTransactionEntity(innerTx, isInnerTx: true));
    }
    /** アグリゲートトランザクション **/
